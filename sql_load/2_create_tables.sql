...
ALTER TABLE public.company_dim OWNER to root;
ALTER TABLE public.skills_dim OWNER to root;
ALTER TABLE public.job_postings_fact OWNER to root;
ALTER TABLE public.skills_job_dim OWNER to root;
